...
interface RoleUsersListModalProps {
  roleId: string;
  roleName: string;
  onClose: () => void;
}

export function RoleUsersListModal({ roleId, roleName, onClose }: RoleUsersListModalProps) {
      ...
      >
        ...
        <div className="space-y-2">
          {loading ? (
            ...
            <div className="text-center py-8 text-gray-500 dark:text-gray-400">
              {search ? 'No users match your search' : 'No users have this role'}
            </div>
          ) : (
        ...
        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
          <div className="text-sm text-gray-600 dark:text-gray-400">
            {users.length} user(s) have this role
          </div>
        </div>
      </motion.div>
    </div>
